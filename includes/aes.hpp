...
public:
   ...
   * <HR>
   ...
   \param ciphertext is a pointer to a 16-byte long array that will contain the encrypted message.
   *
   * <HR>
   */
   ...
   * <HR>
   ...
   \param plaintext is a pointer to a 16-byte long array that will contain the decrypted message.
   *
   * <HR>
   */
